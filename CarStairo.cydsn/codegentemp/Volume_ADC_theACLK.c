...
/*******************************************************************************
* Function Name: Volume_ADC_theACLK_SetDivider
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Volume_ADC_theACLK_SetDivider(uint16 clkDivider)
{
...
/*******************************************************************************
* Function Name: Volume_ADC_theACLK_SetMode
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Volume_ADC_theACLK_SetMode(uint8 clkMode)
{
    uint8 value;


    /* Get the mode and source for the clock. */
    value = *Volume_ADC_theACLK_MOD_SRC;
    ...
    *Volume_ADC_theACLK_MOD_SRC = value;
}


/*******************************************************************************
* Function Name: Volume_ADC_theACLK_SetSource
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Volume_ADC_theACLK_SetSource(uint8 clkSource)
{
    uint8 value;
...
/*******************************************************************************
* Function Name: Volume_ADC_theACLK_SetPhase
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Volume_ADC_theACLK_SetPhase(uint8 clkPhase)
{

    *Volume_ADC_theACLK_PHASE = 0x0Fu & clkPhase;
